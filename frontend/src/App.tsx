...
export default function App() {
  ...
  const navigation = [{name: 'Overview', label: 'Overview', icon: Layers3}, {name: 'Replay', label: 'Replay', icon: GitCompareArrows}, {name: 'Workflows', label: 'Workflows', icon: Workflow}, {name: 'Shared state', label: 'Resources', icon: Database}, {name: 'Event stream', label: 'Activity', icon: Activity}];
